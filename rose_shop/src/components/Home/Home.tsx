...
// internal imports
import shop_image from '../../assets/Images/porsche-taycan-turbo-s-exterior-front-quarter-5dfc91fbc7ada.jpg'
        ...
        <Root>
            ...
            <Main>
                <MainText>
                    ...
                    <Button sx = {{ marginTop: '10px '}} component={Link} to={'/'} variant='contained'>Enter if you have a need for speed......!</Button>
                </MainText>
            </Main>
        </Root>
    )
